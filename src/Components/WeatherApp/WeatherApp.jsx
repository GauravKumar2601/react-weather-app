...
const WeatherApp = () => {
  let api_key = "58acb15585a6c0c891b599bca9c83dae";

  const [wicon, setWicon] = useState(cloud_icon);

  //Default function to get data for Delhi when page loads
  useEffect(() => {
    search();
  }, []);
  ...
  const search = async (city) => {
    ...
    let url = "";
    if (element[0].value === "") {
      //By default showing the data for Delhi
      url = `https://api.openweathermap.org/data/2.5/weather?q=Delhi&units=Metric&appid=${api_key}`;
    } else {
